...
--version 1.12.0 --set mikochi.username=zer0tonin \
...
```sh
wget -c https://github.com/zer0tonin/Mikochi/releases/download/1.12.0/mikochi-1.12.0-linux-amd64.deb

sudo chmod +x mikochi-1.12.0-linux-amd64.deb
sudo apt install mikochi-1.12.0-linux-amd64.deb
sudo mkdir /data
...
```sh
wget -c https://github.com/zer0tonin/Mikochi/releases/download/1.12.0/mikochi-1.12.0-linux-amd64.rpm

sudo chmod +x mikochi-1.12.0-linux-amd64.rpm
sudo rpm -ivh mikochi-1.12.0-linux-amd64.rpm
sudo mkdir /data
...
```sh
wget -c https://github.com/zer0tonin/Mikochi/releases/download/1.12.0/mikochi-1.12.0-linux-amd64.tar.gz -O - | tar -xz

sudo mkdir /data
sudo mkdir /usr/share/mikochi
sudo mv ./mikochi-1.12.0/mikochi /usr/bin/mikochi
sudo mv ./mikochi-1.12.0/static /usr/share/mikochi/static
