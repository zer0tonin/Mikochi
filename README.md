...
(For arm/v7 users, use the `latest-armv7` or `1.4.4-armv7` tag)
...
--version 1.4.4 --set mikochi.username=zer0tonin \
...
```sh
wget -c https://github.com/zer0tonin/Mikochi/releases/download/1.4.4/mikochi-linux-amd64.tar.gz -O - | tar -xz
